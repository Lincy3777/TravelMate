...
interface InputProps {
  ...
  formatPrice?: boolean;
  required?: boolean;
  validation?: object; // Add validation to handle custom rules
...
const Input: React.FC<InputProps> = ({
  ...
  formatPrice,
  required,
  validation, // Include validation here
  register,
  errors,
}) => {
  return (
    <div className="w-full relative">
      ...
      <input
        id={id}
        disabled={disabled}
        {...register(id, { required, ...validation })} // Merge required and validation rules
        placeholder=" "
        type={type}
